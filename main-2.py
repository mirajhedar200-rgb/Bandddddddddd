...
async def ich_menu(m):
    ...
    await m.answer("👤 حساب Ichancy الشكلي\n\nكل العمليات داخل البوت فقط.",reply_markup=inline(rows))
